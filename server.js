...
let widget = {meteo: {state: false, data: {city: 'Paris', temp: '', state: '', icon: ''}, timer: 60},
    ...
    ytSub: {state: false, data: {id: 'UCUaHJ0fTA-1theR8A8Polmw', name: '', subs: ''}, timer: 60},
    ytViews: {state: false, data: {id: 'KcgGS3EvKYA', name: '', views: ''}, timer: 60},
    ytLast: {state: false, data: {id: 'KcgGS3EvKYA', nbr: 5, name: '', comments: []}, timer: 60}};
